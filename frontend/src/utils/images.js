...
*/
// Convierte bytes base64 del backend o del selector de imágenes en un data URI renderizable.
export
...
// Arma el objeto `{ uri }` que esperan los componentes Image de React Native.
export
...
// Normaliza assets devueltos por ImagePicker para que todos los formularios usen el mismo shape.
export
...
// Reduce una imagen seleccionada al payload que el backend espera en formularios con fotos.
export
